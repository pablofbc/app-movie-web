...
export class CreateMovieTheaterComponent implements OnInit {
  ...
  constructor(private _movieTheaterService: MovieTheatersService,
  ...
  saveChanges(movieTheater: movieTheatersCreationDTO) {
    ...
    this._movieTheaterService.create(movieTheater).subscribe(() => this.router.navigate(['/movietheaters']));
  }
